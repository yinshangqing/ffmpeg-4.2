...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86_64 --enable-yasm --enable-asm --enable-shared --disable-static --enable-debug"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "���� x64 �� Microsoft (R) C/C++ �Ż������� 19.00.24215.1 ��"
